...
speedLable = ttk.Label(mainframe, text="Click Interval\n(In miliseconds)").grid(column=1, row=2, sticky=W)
...
stopButton = ttk.Button(mainframe, text="Stop", width=10, command=StateFalse).grid(column=12, row=3, columnspan=2, sticky=E)

mainframe.bind("<F1>", StateTrue())
mainframe.bind("<F2>", StateFalse())
